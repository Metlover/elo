#' Train elo.winpct models with a gridsearch
#'
#' Takes in the arguments of the given elo.winpct function along with an optimization
#' function and a grid of parameters to find the best combination of the
#' parameters.
#' @inheritParams elo.winpct
...
#' fit.elo.winpct(score(points.Home, points.Visitor) ~ adjust(team.Home, hfa) + team.Visitor,
#'             data = tournament,
#'             optimfun = 'mse',
#'             gridsearch = params)
#' @name fit.elo.winpct
